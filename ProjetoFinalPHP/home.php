...
<html lang="en">
    <head>
        ...
        <title>Current Business - Start Bootstrap Template</title>
        <!-- Favicon-->
        ...
        <main class="flex-shrink-0">
            ...
            <section class="content">
                <div class="card">
                    ...
                    <h3 class="card-title"><strong>Current</strong>|Business</h3>
                    ...
                    <div class="row">
                        ...
                        <h3 class="text-primary"><i class="fas fa-box-archive"></i> <strong>Current</strong>|Business</h3>
                        ...
                        <div class="text-muted">
                            ...
                            <b class="d-block"><strong>Current</strong>|Bunisess</b>
                            </p>
                            <p class="text-sm">Desenvolvedor
                            <b class="d-block">Thalita Guimarães Vasconcellos - Projeto Final PHP</b>
                            </p>
                        </div>
                        </div>
                    </div>
